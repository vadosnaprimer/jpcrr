...
//     }
    ...
    private int doFPUOp_real(int op, int nextOp, Segment seg0, int addr0)
    {
        switch(op) {
...
//      } return 0;
    ...
    private int doFPUOp_protected(int op, int nextOp, Segment seg0, int addr0)
    {
        switch(op) {
        case FWAIT: checkExceptions(); return 0;
        case FLOAD0_ST0:
...
//                  return 0;
    ...
    public int doFPUOp(int op, int nextOp, Segment seg0, int addr0, int _reg0, int _reg1, int _reg2, long _reg0l)
    {
         ...
         if(protmode)
             return doFPUOp_protected(op, nextOp, seg0, addr0);
         else
             return doFPUOp_real(op, nextOp, seg0, addr0);
    }
