...
public class CombiningRealCodeBlock implements RealModeCodeBlock
{
    ...
    public CombiningRealCodeBlock(CodeBlock block0, CodeBlock block1, CodeBlock block2, int start, int jumpSize)
    {
        this.block0 = block0;
        this.block1 = block1;
        this.block2 = block2;
        if (jumpSize < block1.getX86Length())
            ...
            x86Length = block0.getX86Length() + jumpSize + block2.getX86Length();
